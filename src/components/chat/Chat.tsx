...
const Chat = () => {
  ...
  function testMessage() {
    ...
    addMessage({
      ...
      profile: {
        ...
        avatar:
          "https://avatars.steamstatic.com/6293098db568fafd849388410fdb075fd19e577a_full.jpg",
        level: 5,
        rank: 2,
      },
    });
  ...
  return (
    <>
      <div
        class="flex-col overflow-hidden hidden xl:flex absolute right-0 h-[calc(100%_-_7rem)] w-[var(--sidebar-width)] text-gray-100 border-l border-site-600 transform transition-transform"
        classList={{ "translate-x-[var(--sidebar-width)]": !opened() }}
      >
        <div>
          chat
      ...
      <div
        ...
        classList={{ "opacity-0": opened(), "opacity-100": !opened() }}
      >
