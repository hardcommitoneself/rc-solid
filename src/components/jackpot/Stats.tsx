    ...
    <>
      <div class="flex my-4 gap-x-4">
        <div class="flex-1 flex-shrink-0 border-2 border-site-600 rounded h-24 flex flex-col items-center justify-center gap-y-1">
          <span class="text-gray-50 text-xs font-light uppercase">
            {t("jackpot.your-chance")}
          </span>
          <span class="text-gray-50 font-medium text-xl tracking-wide">
            {stats().chance.toFixed(2)}%
          </span>
        </div>
        <div class="flex-1 flex-shrink-0 border-2 border-site-600 rounded h-24 flex flex-col items-center justify-center gap-y-1">
          <span class="text-gray-50 text-xs font-light uppercase">
            {t("jackpot.your-items")}
          </span>
          <span class="text-gray-50 font-medium text-xl tracking-wide">
            {stats().items}
          </span>
        ...
        <div class="flex-1 flex-shrink-0 border-2 border-site-600 rounded h-24 flex flex-col items-center justify-center gap-y-1">
          <span class="text-gray-50 text-xs font-light uppercase">
            {t("jackpot.your-value")}
          </span>
          <span class="text-gray-50 font-medium text-xl tracking-wide">
            {priceFormatter.format(stats().value / 100)}
          </span>
        </div>
      </div>
